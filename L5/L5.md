...
L5 is a new Processing/p5 creative coding library independently initiated, implemented in Lua with the LÖVE framwork. It is designed with permacomputing principles - to be lightweight, work on the widest variety of machines, stay true to the Processing approach, balanced with constraints to support running on resource-constrained machines.
